...
void shocker::ui::show_battery_window() {
    ...
    QRect scr = ui::qapp->desktop()->screenGeometry();
    ...
    ui::qapp->setStyleSheet(stylesheet);
    ...
    QObject::connect(off, SIGNAL(timeout()), ui::qapp, SLOT(quit()));
    off->start();
}
